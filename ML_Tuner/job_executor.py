...
5. Producer 生命周期管理: 自动启动/停止本地 SeismicProducer
...
class JobExecutor:
    ...
    def _start_producer(self):
        ...
        log_dir = os.path.join(self._producer_work_dir, 'ML_Tuner', 'logs')
        ...
        try:
            ...
            logger.info("✅ Producer 已启动: PID=%d, log=%s",
                        self._producer_process.pid, log_path)
